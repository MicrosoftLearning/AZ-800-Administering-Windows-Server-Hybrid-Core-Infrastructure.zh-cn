...
1. 如果需要，请确保已选中“**为此连接使用另一个帐户**”选项，输入讲师提供的凭据，然后选择“**使用凭据添加**”。

1. 在 **sea-svr3.contoso.com** 页上的“**工具**”菜单中，选择 **PowerShell**，然后在出现提示时，使用讲师提供的凭据登录。
...
1. 确保已选中“**为此连接使用另一个帐户**”选项，输入讲师提供的凭据，然后选择“**使用帐户连接**”。
