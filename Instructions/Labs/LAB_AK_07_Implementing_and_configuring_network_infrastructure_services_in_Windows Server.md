...
## <a name="exercise-1-deploying-and-configuring-dhcp"></a>                **注意：** 我们提供 **[交互式实验室模拟](https://mslabs.cloudguides.com/guides/AZ-800%20Lab%20Simulation%20-%20Implementing%20and%20configuring%20network%20infrastructure%20services%20in%20Windows%20Server)** ，让你能以自己的节奏点击浏览实验室。

#### <a name="task-1-install-the-dhcp-role"></a>你可能会发现交互式模拟与托管实验室之间存在细微差异，但演示的核心概念和思想是相同的。
...
1. 注意：如果尚未在 SEA-ADM1 上安装 Windows Admin Center，请执行后面两个步骤 。
   ...
   > 在 Windows PowerShell 控制台中，输入以下命令，然后按 Enter 下载最新版本的 Windows Admin Center： 输入以下命令，然后按 Enter 安装 Windows Admin Center：

1. 备注：请等待安装完成。

   >这大约需要 2 分钟。 在 SEA-ADM1 上，启动 Microsoft Edge，然后浏览到 `https://SEA-ADM1.contoso.com`。 
...
1. 在“添加或创建资源”窗格中的“服务器”磁贴上，选择“添加” 。
   ...
   - 在“服务器名称”文本框中，输入“sea-svr1.contoso.com” 。
   - 确保已选中“为此连接使用另一个帐户”选项，输入以下凭据，然后选择“使用凭据添加” ：

   > 用户名：CONTOSO\\Administrator

1. 密码：Pa55w.rd
1. 备注：若要执行单一登录，你需要设置 Kerberos 约束委派。
1. 在 sea-svr1.contoso.com 页面上的“工具”列表中，选择“角色和功能”  。

   > 在“角色和功能”窗格中，选中“DHCP 服务器”复选框，然后选择“+ 安装” 。 在“安装角色和功能”窗格中，选择“是”。

1. 备注：请等待指示已安装 DHCP 角色的通知。 

   > 如有必要，请选择“通知”图标以验证当前状态。

1. 刷新 Microsoft Edge 页面，返回到 sea-svr1.contoso.com 页面上，在“工具”列表中，选择“DHCP”，然后在详细信息窗格中，选择“安装”以安装 DHCP PowerShell 工具    。 备注：如果 sea-svr1.contoso.com 的“工具”列表中未提供“DHCP”条目，请刷新 Microsoft Edge 页面，然后重试    。

#### <a name="task-2-authorize-the-dhcp-server"></a>等待指示已安装 DHCP PowerShell 工具的通知。

1. 如有必要，请选择“通知”图标以验证当前状态。
1. 任务 2：对 DHCP 服务器授权
1. 在 SEA-ADM1 上，选择“开始”，然后选择“服务器管理器”  。
1. 在“服务器管理器”中，选择菜单中的“通知”，然后选择“完成 DHCP 配置”  。
1. 在“DHCP 安装后配置向导”窗口中的“说明”屏幕上，选择“下一步”  。

#### <a name="task-3-create-a-scope"></a>在“授权”屏幕上，确保已选中“CONTOSO\\Administrator”选项，然后选择“提交”  。

1. 完成这两项任务后，选择“关闭”。

   > 任务 3：创建范围 在 SEA-ADM1 上，在 Microsoft Edge 窗口中切换到 Windows Admin Center，其中显示了 SEA-SVR1 上的“DHCP”设置  。 **注意**：DHCP 选项可能需要几分钟时间才会出现在菜单中。

1. 如有必要，请刷新与 sea-svr1 的连接。
1. 如果系统提示安装 DHCP Powershell 工具，请选择“安装”。

   - 在“DHCP”页面上，选择“+ 新建范围” 。
   - 在创建新范围的窗格中，指定以下设置，然后选择“创建”。
   - 协议：IPv4
   - 名称：ContosoClients
...
1. 路由器（默认网关）：10.100.150.1
1. DHCP 客户端的租约持续时间：4 天
...
1. 在“DHCP”窗口中，依次展开“172.16.10.12”、“IPv4”和“范围 [10.100.150.0] ContosoClients”，然后选择“范围选项”    。
1. 在“操作”窗格中，选择“更多操作”，然后选择“配置选项” 。

#### <a name="task-4-configure-dhcp-failover"></a>在“范围选项”对话框中，选中“006 DNS 服务器”复选框 。
...
1. 在“添加服务器”对话框中，选择“此已授权的 DHCP 服务器”，选择“sea-dc1.contoso.com”，然后选择“确定”   。
   ...
   - 返回到“指定要用于故障转移的伙伴服务器”屏幕上，确保“sea-dc1”出现在“伙伴服务器”下拉列表中，然后选择“下一步”   。
   - 在“创建新的故障转移关系”屏幕上，输入以下信息，然后选择“下一步” 。
...
1. 在“从已在此服务器上配置的故障转移关系中选择”屏幕上，选择“下一步”，然后选择“完成”  。 在“配置故障转移”对话框中，选择“关闭” 。

#### <a name="task-5-verify-dhcp-functionality"></a>在“172.16.10.12”下，选择“IPv4”，然后验证是否已列出了两个范围 。
...
1. 选择“172.16.10.12”，在“操作”窗格中，选择“更多操作”，选择“所有任务”，然后选择“停止”   。
...
1. 在“以太网状态”窗口中，选择“属性” 。
   ...
   - 在“以太网属性”对话框中，选择“Internet 协议版本 4 (TCP/IPv4)”，然后选择“属性”  。
   - 在“Internet 协议版本 4 (TCP/IPv4) 属性”对话框中，选择“使用以下 IP 地址”，并指定以下设置 ：
   - IP 地址：172.16.10.11

1. 子网掩码：255.255.0.0

   > 默认网关：172.16.10.1 在“Internet 协议版本 4 (TCP/IPv4) 属性”对话框中，选择“使用以下 DNS 服务器地址”，将“首选 DNS 服务器”设置为“172.16.10.10”，然后选择“确定”    。 

## <a name="exercise-2-deploying-and-configuring-dns"></a>备注：使“以太网状态”窗口保持打开状态 。

#### <a name="task-1-install-the-dns-role"></a>本实验室中稍后会用到它。
...
1. 在“工具”列表中，选择“角色和功能” 。
   ...
   > 在“角色和功能”窗格中，选中“DNS 服务器”复选框，然后选择“+ 安装” 。 在“安装角色和功能”窗格中，选择“是”。

1. 备注：请等待指示已安装 DNS 角色的通知。 

   > 如有必要，请选择“通知”图标以验证当前状态。

1. 刷新 Microsoft Edge 页面，返回到 sea-svr1.contoso.com 页面上，在“工具”列表中，选择“DNS”，然后在详细信息窗格中，选择“安装”以安装 DNS PowerShell 工具    。 备注：如果 sea-svr1.contoso.com 的“工具”列表中未提供“DNS”条目，请刷新 Microsoft Edge 页面，然后重试    。

#### <a name="task-2-create-a-dns-zone"></a>等待出现指示已安装 DNS PowerShell 工具的通知。

1. 如有必要，请选择“通知”图标以验证当前状态。
1. 任务 2：创建 DNS 区域

   - 在 SEA-ADM1 上，在 Windows Admin Center 中的 DNS 窗格中，选择“操作”，然后在“操作”菜单上，选择“+ 创建新的 DNS 区域”   。
   - 在“创建新的 DNS 区域”对话框中，指定以下设置，然后选择“创建” ：
   - 区域类型：主要
   - 区域名称：TreyResearch.net
   - 区域文件：创建新文件

1. 区域文件名：TreyResearch.net.dns
1. 动态更新：不允许动态更新

   - 返回到 DNS 窗格中，选择“TreyResearch.net”，然后选择“+ 创建新的 DNS 记录” 。
   - 在“创建新 DNS 记录”窗格中，指定以下设置，然后选择“创建” ：
   - DNS 记录类型：主机 (A)
   - 记录名称：TestApp

1. IP 地址：172.30.99.234
1. 生存时间：600
...
#### <a name="task-3-configure-forwarding"></a>在 SEA-ADM1 上，选择“开始”，然后选择“Windows PowerShell”  。
...
#### <a name="task-4-configure-conditional-forwarding"></a>在“编辑转发器”对话框中，在“转发服务器的 IP 地址”框中，输入“131.107.0.100”，然后选择“确定”   。
...
1. 选择“条件转发器”，显示其上下文相关菜单，然后在菜单中，选择“新建条件转发器” 。
   ...
   > 在“新建条件转发器”对话框中，在“DNS 域”框中，输入“Contoso.com”  。

1. 在“主服务器的 IP 地址”框中，输入“172.16.10.10”，然后选择 Enter  。
1. 备注：忽略“新建条件转发器”对话框内验证列中“出现未知错误”的消息  。
1. 选择“确定”。
...
#### <a name="task-5-configure-dns-policies"></a>在 SEA-ADM1 上，切换到 Windows PowerShell 控制台 。
...
#### <a name="task-6-verify-dns-policy-functionality"></a>输入以下命令，然后按 Enter 为总部范围添加新资源记录：

1. 输入以下命令，然后按 Enter 创建链接总部子网和区域范围的新策略：
1. 任务 6：验证 DNS 策略功能

   > 在 SEA-ADM1 上，切换到 Windows PowerShell 控制台 。
...
1. 备注：验证名称是否解析为在 HeadOfficePolicy 中配置的 IP 地址 172.30.99.100  。
...
1. 在“Internet 协议版本 4 (TCP/IPv4) 属性”对话框中，将当前分配的 IP 地址 (172.16.10.11) 更改为不在 HeadOfficeSubnet 的 IP 地址范围内的一个 IP 地址 172.16.11.11，然后选择“确定”    。
   ...
   > 在 SEA-ADM1 上，切换到 Windows PowerShell 控制台 。 在 Windows PowerShell 控制台中，输入以下命令，然后按 Enter 测试 `testapp.treyresearch.net` DNS 记录的解析： 备注：验证名称是否解析为 172.30.99.234 。 这是意料之中的，因为 SEA-ADM1 的 IP 地址已经不在 HeadOfficeSubnet 内 。

   > 从 HeadOfficeSubnet (172.16.10.0/24) 向 `testapp.treyresearch.net` 发起的 DNS 查询解析为 172.30.99.100  。

1. 从此子网外部向 `testapp.treyresearch.net` 发起的 DNS 查询解析为 172.30.99.234。
1. 备注：现在将 SEA-ADM1 的 IP 地址更改回其原始值 。
