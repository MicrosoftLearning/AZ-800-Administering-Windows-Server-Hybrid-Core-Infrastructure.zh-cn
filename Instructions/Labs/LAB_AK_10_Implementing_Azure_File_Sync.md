...
1. 在“**存储帐户**”页上，选择“**存储浏览器**”，选择“**文件共享**”菜单，然后选择“**+ 文件共享**”。
...
1. 浏览回“**文件共享**”菜单，选择 **share1** 的省略号，然后在显示的列表上选择“**查看快照**”。
1. 在“**文件共享快照**”页上，选择“**添加快照**”，然后单击“**确定**”。
1. 浏览回“**文件共享**”菜单，选中表示“**share1**”的框，然后选择“**连接**”，选择“**显示脚本**”，使用“**复制到剪贴板**”按钮复制脚本，然后关闭“**连接**”选项卡。
